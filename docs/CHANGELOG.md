# 2068-Leap-Forth changelog

Phase-by-phase build history, extracted from what used to be the
README's own "Status" section. See [`PROJECT_PLAN.md`](PROJECT_PLAN.md)
for the full design rationale, bugs found, and fixes behind each phase —
this is the condensed one-paragraph-per-phase version.
